...
//		httpclient.getParams().setBooleanParameter("http.protocol.expect-continue", false);
	...
	public static CloseableHttpClient createHttpsClient() throws Exception {
		...
		return HttpClients.custom().setSSLSocketFactory(sslsf)
				.setConnectionManager(new HttpClientConnectionManagerDecorator(createConnectionManager())).build();
	}
	...
	public static CloseableHttpClient getHttpClient(int timeout){
		...
		CloseableHttpClient httpClient = HttpClients.custom().setDefaultRequestConfig(requestConfig)
				...
				.setConnectionManager(new HttpClientConnectionManagerDecorator(createConnectionManager()))
				.build();
		return httpClient;
	}
